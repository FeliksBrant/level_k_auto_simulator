/***************************************************************************
    ...
    modified time        : 2018-02-22 01:05:55
    modified by          : guanksu
...
static const char* botname[NBBOTS] = {
    "level1 10", "level1 11", "level1 12", "level1 13", "level1 14", 
    "level1 15", "level1 16", "level1 17", "level1 18", "level1 19"
};
