...
static const char* botname[NBBOTS] = {
    "level0 10", "level0 11", "level0 12", "level0 13", "level0 14", 
    "level0 15", "level0 16", "level0 17", "level0 18", "level0 19"
};
...
{ 
    ...
    driver[index] = new Driver(index+10);
