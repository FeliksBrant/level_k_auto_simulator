...
class SingleCardata {
	public:
		...
		inline float getAccelInTrackDirection() { return accel; }
		inline float getPosInTrackDirection() { return pos; }
	...
	protected:
		...
		static float getAccel(tCarElt *car, float trackangle);
		static float getPosition(tCarElt *car, float trackangle);

		float pos; 			// position in direction of the track.
		float speed;		// speed in direction of the track.
		float accel;		// acceleration in direction of the track.
