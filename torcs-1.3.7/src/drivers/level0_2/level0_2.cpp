/***************************************************************************
    ...
    file                 : level0_2.cpp
    created              : Thu Feb 22 00:40:04 EST 2018
...
static const char* botname[NBBOTS] = {
    "level0 20", "level0 21", "level0 22", "level0 23", "level0 24", 
    "level0 25", "level0 26", "level0 27", "level0 28", "level0 29"
};
...
{ 
    ...
    driver[index] = new Driver(index+20);
