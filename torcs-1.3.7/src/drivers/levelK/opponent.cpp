/***************************************************************************
    ...
    modified time        : 2018-01-19 15:30:39
    modified by          : guanksu
    summary              : 
...
void Opponent::update(tSituation *s, LevelKDriver *driver)
{
...
Opponents::Opponents(tSituation *s, LevelKDriver *driver, Cardata *c)
{
...
void Opponents::update(tSituation *s, LevelKDriver *driver)
{
	int i;
